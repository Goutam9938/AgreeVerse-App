        ...
        <div className="lg:flex">
          ...
          >
            <nav className="flex items-center gap-8">
              ...
              <Link to="/marketplace" className="nav-link hover:text-gray-600 transition-colors">
                Buyer Marketplace
              </Link>
              <Link to="/community" className="nav-link hover:text-gray-600 transition-colors">
                Community Forum
              </Link>
              <Link to="/resources" className="nav-link hover:text-gray-600 transition-colors">
                Resources & Training
              </Link>
            </nav>
            <div
                    ...
                    <div className="grid flex-1 gap-x-8 gap-y-6 py-4 pr-8 md:grid-cols-2 md:px-0 md:py-8 lg:py-8 lg:pr-8">
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Farmers Hub</h5>
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Buy Products</h5>
                            <p className="hidden text-sm md:block">
                              Browse a wide range of agricultural products.
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Learn farming techniques and business strategies.
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Support Forum</h5>
                            <p className="hidden text-sm md:block">
                      ...
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Blog Articles</h5>
                            <p className="hidden text-sm md:block">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Latest News</h5>
                            <p className="hidden text-sm md:block">
                              Discover important updates and announcements.
                            </p>
                          </div>
                        </a>
                      </div>
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[auto_auto] items-start gap-y-2 lg:grid-rows-[auto]">
                          ...
                          >
                            ...
                            <div className="rt-4 mt-4 flex flex-col justify-start md:mt-0">
                              ...
                              <p className="text-sm">
                                Explore eco-friendly practices for your farm.
                              </p>
